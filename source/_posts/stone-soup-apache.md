...
![2019 年开始孵化以后，开发活动与日俱增，甚至原始作者都不是最活跃的提交者](hudi-commit-graph.png)

![自然增长的 Star 代表的声量曲线近似二次函数](hudi-star-history.png)

![参与开发的人数曲线甚至接近指数函数](hudi-contributor-graph.svg)
